...
public class EndlessTerrain : MonoBehaviour {
    ...
    const float sqrMoveTresholdForChunkUpdate = viewerMoveTresholdForChunkUpdate * viewerMoveTresholdForChunkUpdate;
    ...
    private void Update() {
        ...
        if((viewerPositionOld - viewerPosition).sqrMagnitude > sqrMoveTresholdForChunkUpdate) {
